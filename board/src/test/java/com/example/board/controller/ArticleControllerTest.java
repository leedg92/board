...
class ArticleControllerTest {
    ...
    void givenAuthorizedUser_whenRequestingArticleView_thenReturnsArticleView() throws Exception {
        ...
        Long articleId = 1L;
        long totalCount = 1L;
        given(articleService.getArticleWithComments(articleId)).willReturn(ACREATEArticleWithCommentsDto());
    ...
    void givenAuthorizedUser_whenRequesting_thenReturnsUpdatedArticlePage() throws Exception {
        // Given
        long articleId = 1L;
        ArticleDto dto = ACREATEArticleDto();
        ...
        mvc.perform(get("/articles/" + articleId + "/form"))
                ...
                .andExpect(model().attribute("formStatus", FormStatus.AUPDATE));
    ...
    private ArticleDto ACREATEArticleDto() {
        return ArticleDto.of(
                ACREATEUserAccountDto(),
                "title",
                "content",
    ...
    private ArticleWithCommentsDto ACREATEArticleWithCommentsDto() {
    ...
    private UserAccountDto ACREATEUserAccountDto() {
