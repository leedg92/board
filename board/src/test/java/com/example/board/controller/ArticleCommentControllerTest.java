...
class ArticleCommentControllerTest {
    ...
    @Test
    void givenCommentInfo_whenRequesting_thenSavesNewArticleComment() throws Exception {
        // Given
        Long articleId = 1L;
        Long articleCommentId = 1L;
        ArticleCommentRequest articleCommentRequest = ArticleCommentRequest.of(articleCommentId,articleId, "test comment");
    ...
    @Test
    void givenUpdatedArticleCommentInfo_whenRequesting_thenUpdatesNewArticleComment() throws Exception {
        // Given
        long articleId = 1L;
        long articleCommentId = 1L;
        ArticleCommentRequest articleCommentRequest = ArticleCommentRequest.of(articleCommentId,articleId, "test comment");
        ...
        // When & Then
        mvc.perform(
                        post("/comments/" + articleCommentId + "/" + articleCommentId + "/form")
                                .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                                .content(formDataEncoder.encode(articleCommentRequest))
                                .with(csrf())
                )
