...
class JpaRepositoryTest {
    ...
    void givenParentCommentId_whenSelecting_thenReturnsChildComments(){
        ...
        // Then
        assertThat(parentComment).get() //assertj에서 Optional안에 있는 데이터들을 꺼내면서 null체크를 함(이 자체로써 테스트기능함)
                .hasFieldOrPropertyWithValue("parentCommentId",null)
                .extracting("childComments", InstanceOfAssertFactories.COLLECTION)  //자식댓글의 이름을 직접 지정 후 타입체크
                        .hasSize(4);
    }
