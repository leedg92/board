...
<div class="container">
  ...
  <form id="article-form" action="/comments/${articleId}/${articleComment.id()}/form/jsp" method="post">


    <div class="row mb-3 justify-content-md-center">
      <label for="content" class="col-sm-2 col-lg-1 col-form-label text-sm-end">댓글</label>
